...
python "$PROJECT_ROOT/pipeline.py" \
  ...
  --output_dir "$PROJECT_ROOT/runs/exp_cpu_diffusion_x8_numeric_full_1m15_1m35" \
  ...
  --diffusion_selective_min_frontalness 0.55 \
  --diffusion_selective_max_crops 2 \
